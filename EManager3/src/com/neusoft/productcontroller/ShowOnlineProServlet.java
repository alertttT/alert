...
/**
 * Servlet implementation class ShowOnlineProServlet
 */
@WebServlet("/showonline")
public class ShowOnlineProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowOnlineProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageModel<T_Product_List> pm = ps.showOnlineProduct(pageNo, pageSize);
		...
		request.getRequestDispatcher("hot2.jsp").forward(request, response);
	}
