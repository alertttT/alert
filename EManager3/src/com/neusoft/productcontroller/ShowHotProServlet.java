...
/**
 * Servlet implementation class ShowHotProServlet
 */
@WebServlet("/showhot")
public class ShowHotProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowHotProServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageModel<T_Product_List> pm = ps.showHotProduct(pageNo, pageSize);
